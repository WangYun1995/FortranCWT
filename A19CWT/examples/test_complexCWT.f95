...
Program test
  ...
  Call CPU_time(t1)
  ! Perform the CWT
  Call cA19CWT_periodbc( signal, Nmesh, Lbox, Nsubs, wavelet, scales, Nscales, realcwt, imagcwt )
  ! Perform the CWT
  ! Call cA19CWT_zerobc( signal, Nmesh, Lbox, Nsubs, wavelet, scales, Nscales, realcwt, imagcwt )
  Call CPU_time(t2)
