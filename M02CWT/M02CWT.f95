...
Module M02CWT
  ...
  !--------------------------------------------------------------!
  Subroutine rM02CWT_zerobc( signal, Nmesh, Lbox, Nsubs, wavelet_name, scales, Nscales, CWT )

    ! input variables
    Integer, Intent(in) :: Nmesh
    Integer, Intent(in) :: Nsubs
    Real(8), Intent(in) :: Lbox
    Real(8), Dimension(1:Nmesh), Intent(in) :: signal
  ...
  !--------------------------------------------------------------!
  Subroutine rM02CWT_periodbc( signal, Nmesh, Lbox, Nsubs, wavelet_name, scales, Nscales, CWT )
  ...
  ! zero boundary condition
  !--------------------------------------------------------------!
  Subroutine cM02CWT_zerobc( signal, Nmesh, Lbox, Nsubs, wavelet_name, scales, Nscales, realCWT, imagCWT )
  ...
  ! periodic boundary condition
  !--------------------------------------------------------------!
  Subroutine cM02CWT_periodbc( signal, Nmesh, Lbox, Nsubs, wavelet_name, scales, Nscales, realCWT, imagCWT )
